...
class PaiementCredit extends Operation
{
    ...
    public function ajout()
    {
        ...
        $sql = "INSERT INTO paiementCredit (num_op) VALUES (:numOp)";
        $stmt = $this->cnx->prepare($sql);
    ...
    {
        $sql = "DELETE FROM PaiementCredit WHERE num_op=:numOp";
        $statement = $cnx->prepare($sql);
    ...
    {
        $sql = "SELECT * FROM PaiementCredit";
        $statement = $cnx->prepare($sql);
        $statement->execute();
        $paiements = [];
